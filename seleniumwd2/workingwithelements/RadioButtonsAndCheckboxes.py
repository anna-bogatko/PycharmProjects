...
class RadioButtonsAndCheckboxes():
    ...
    def test(self):
        ...
        print("BMW Radio button is selected? " + str(bmwRadioBtn.is_selected())) # True is selected and False if not selected
        print("Benz Radio button is selected? " + str(benzRadioBtn.is_selected())) # True is selected and False if not selected
