...
class DynamicXPathFormat():
    ...
    def test(self):
        ...
        # Select Course
        _course = "//div[contains(@class,'course-listing-title') and contains(text(),'{0}')]" #We have replaced text with {0}
        #We can add more locators -> _course = "//div[contains(@class,'course-listing-title') and contains(text(),'{0}{1}{2}')]"
        #Than it will look like this -> _courseLocator = _course.format("Learn Python 3 from scratch", "Javascript for beginners" etc.)
